...
// Define types for the industry structure
interface Industry {
    id: string;
    name: string;
...
// Define props type for the OnboardingForm
interface OnboardingFormProps {
    industries: Industry[];
}

// Define form values based on the inputs
interface FormValues {
    industry: string;
    subIndustry: string;
    experience: number;
    skills?: string[]; // skills is now an array of strings or undefined
    bio?: string;
}
